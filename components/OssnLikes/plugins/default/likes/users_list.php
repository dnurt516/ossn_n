...
foreach ($users as $user) {
	...
	<div class="ossn-reactions-list-wholiked-item">
		<div class="row justify-content-start">
			<div class="col-auto pr15">
				<img src="<?php echo $icon; ?>" width="60" height="60"/>
			</div>
			<div class="col-auto">
				<div class="ossn-reactions-list-whoreacted-uinfo">
					<a class="userlink" href="//<?php echo $_SERVER['SERVER_NAME']; ?>/user/<?php echo $user->guid; ?>"><?php echo $user->fullname; ?></a>
