				  ...
				  <div class="item">
                                ...
                                <span>
                                    ...
                                    <div class="edit">
											...
											?>	
                                    	<a href="<?php echo ossn_site_url("action/family/relation/cancel?guid={$member->guid}", true);?>" class="badge bg-danger ossn-make-sure"><i class="fa fa-times"></i></a>
                                    </div>                                                              
                                    <div class="type">
                            ...
                            <div class="col-md-11 col-xs-9">
                            	<div class="user-details">
                                    <div class="edit">
											...
											?>	
                                    	<a href="<?php echo ossn_site_url("action/family/member/cancel?guid={$member->guid}", true);?>" class="badge bg-danger ossn-make-sure"><i class="fa fa-times"></i></a>
                                    </div>                                                              
                                	<a href="<?php echo $user->profileURL();?>"><?php echo $user->fullname;?></a>
                                    <div class="type">
                                    	<?php echo $member->getType();?>
