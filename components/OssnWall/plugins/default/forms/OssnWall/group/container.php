...
<div class="ossn-wall-container-data ossn-wall-container-data-post" data-type="post">
    ...
    <div class='ossn-wall-post-button-container'>
            ...
            <input class="btn btn-post ossn-wall-post" type="submit" value="<?php echo ossn_print(''); ?>" />
    </div>  
    <div class="ossn-wall-privacy-dummy">
    		<?php if($params['group']['group']->membership == OSSN_PUBLIC){ ?>
            <span title="<?php echo ossn_print('privacy:group:public');?>"><i class="ossn-wall-privacy-lock fa fa-lock"></i><span class=""><?php echo ossn_print(''); ?></span></span>
            <?php } else {?>
            <span title="<?php echo ossn_print('privacy:group:close');?>"><i class="ossn-wall-privacy-lock fa fa-lock"></i><span class=""><?php echo ossn_print(''); ?></span></span>            
            <?php } ?> 
    </div>          
