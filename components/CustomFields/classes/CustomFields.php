...
class CustomFields extends OssnObject {
		...
		public function getArgs() {
				if (isset($this->field_name)) {
						...
						if($langauge != 'en'){
							$options['label'] = ossn_print("customfields:translate:{$this->field_name}");	
							$options['placeholder'] = ossn_print("customfields:translate:{$this->field_name}");	
						}
						...
						if ($this->showLabel()) {
								$options['label'] = $this->placeholder;
						} else {
							    unset($options['label']);
						}						
