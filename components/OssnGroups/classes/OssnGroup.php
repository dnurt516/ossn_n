...
class OssnGroup extends OssnObject {
		...
		public function createGroup($params){
				...
				$this->proj_id       = (($params['proj_id'])?$params['proj_id']:NULL);
				$this->comp_id       = (($params['comp_id'])?$params['comp_id']:NULL);
		...
		public function getGroup($guid){
				$this->object_guid = $guid;
 			    $options = array();
  			    $options['subtype'] = "ossngroup";
				$group             = $this->getObjectById($options);
