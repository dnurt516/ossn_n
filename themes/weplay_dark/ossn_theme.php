 ...
 */
define('__THEMEDIR__', ossn_route()->themes . 'weplay_dark/');

ossn_register_callback('ossn', 'init', 'ossn_weplay_dark_theme_init');

function ossn_weplay_dark_theme_init(){	
	//add bootstrap
	...
	ossn_extend_view('ossn/admin/head', 'ossn_weplay_dark_admin_head');
	ossn_extend_view('ossn/site/head', 'ossn_weplay_dark_head');
    ossn_extend_view('js/opensource.socialnetwork', 'js/weplay_dark');	
}
function ossn_weplay_dark_head(){
	$head	 = array();
...
function ossn_weplay_dark_admin_head(){
	$head	 = array();	
	$head[]  = ossn_html_css(array(
					'href' => '//cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css',
			  ));	
