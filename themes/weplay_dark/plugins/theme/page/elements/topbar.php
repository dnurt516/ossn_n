...
<div class="topbar">
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-xs-12 left-side left">
            ...
            <div class="col-md-6 col-4">
                	<div class="topbar-userdata">
                        ...
                        <span class="name d-none d-sm-inline-block"><?php echo ossn_loggedin_user()->fullname;?></span>
                        <span class="homelink"><a href="<?php echo ossn_site_url();?>home"><?php echo ossn_print('network');?></a></span>
                        <span class="homelink"><a href="https://weplay.io/"><?php echo ossn_print('weplay.io');?></a></span>
                    </div>            
            </div>
			<div class="col-8 col-md-3 col-xs-12 text-right right-side">
