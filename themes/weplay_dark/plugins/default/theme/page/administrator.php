...
<head>
    ...
    <link rel="icon" href="<?php echo ossn_add_cache_to_url(ossn_theme_url().'images/favicon.svg');?>" type="image/x-icon" />	
...
<body>
	...
	<div class="header">
    	<div class="container">
			...
			<div class="col-6 col-md-6">
            			...
            			<img src="<?php echo ossn_theme_url(); ?>images/logo_admin.png"/>
                        <?php } else { ?>
            			<img src="<?php echo ossn_theme_url(); ?>images/logo_admin.png?ver=<?php echo time();?>"/>                        
                        <?php } ?> 
            		</div>
	...
	<div class="container">
        ...
        <footer>
      	  	<div class="row">
        		<div class="col-md-6">
 				<?php echo ossn_print('copyright'); ?> <?php echo date("Y"); ?> <a href="https://weplay.io"><?php echo $site_name; ?></a>            			
           	 	</div>
